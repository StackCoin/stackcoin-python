...
if TYPE_CHECKING:
    from ..models.request_response_requester import RequestResponseRequester
    from ..models.request_response_responder import RequestResponseResponder
...
class RequestResponse:
    """Response schema for single request
    ...
    Attributes:
        ...
        requester (RequestResponseRequester):
        responder (RequestResponseResponder):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requester = RequestResponseRequester.from_dict(d.pop("requester"))

        responder = RequestResponseResponder.from_dict(d.pop("responder"))
