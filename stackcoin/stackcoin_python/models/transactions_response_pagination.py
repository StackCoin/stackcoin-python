...
T = TypeVar("T", bound="TransactionsResponsePagination")


@_attrs_define
class TransactionsResponsePagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transactions_response_pagination = cls(
            limit=limit,
            page=page,
            total=total,
        ...
        transactions_response_pagination.additional_properties = d
        return transactions_response_pagination
