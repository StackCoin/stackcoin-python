...
T = TypeVar("T", bound="DiscordGuildsResponsePagination")


@_attrs_define
class DiscordGuildsResponsePagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discord_guilds_response_pagination = cls(
            limit=limit,
            page=page,
            total=total,
        ...
        discord_guilds_response_pagination.additional_properties = d
