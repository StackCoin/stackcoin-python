...
T = TypeVar("T", bound="RequestsResponsePagination")
...
class RequestsResponsePagination:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requests_response_pagination = cls(
            limit=limit,
            page=page,
            total=total,
        ...
        requests_response_pagination.additional_properties = d
        return requests_response_pagination
